...
| AC-05 (POC 課題解消) | TODO.md P1-1〜P1-7 が新要件で被覆されていることを §12 のトレース表で確認 | 全ての P1 項目に対応する FR / NFR が紐付き、Phase 5 で実装確認できる |
...
## 12. トレーサビリティ — POC TODO.md P1 ↔ 要件 ID
